...
# Copy hosts file and wrapper script to mini2
scp -q hosts_mlx.json run_server.sh mini2@192.168.5.2:/Users/mini2/Movies/mlx_grpc_inference/

echo "Launching unified distributed job..."
echo ""

# Use mlx.launch with the wrapper script that's in both directories
cd /Users/mini1/Movies/mlx_grpc_inference
mlx.launch --hostfile hosts_mlx.json --backend ring --verbose bash run_server.sh